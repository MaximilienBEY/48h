  ...
  return (
    <Quiz
      ...
      questions={[
        ...
        {
          title: "JavaScript",
          description: "Quel est l'operateur qui permet de savoir le type de la variable en js ?",
          choices: [
        ...
        {
          title: "'Super Globla'",
          description: "Quel sont les variable 'Super Globla' en php ?",
          choices: [
        ...
        },
        {
          title: "Object Map",
          description:
            "Re faire la class \"Map()\" sans utilisé le \"new Map()\". Voir cette exemple pour réponde a la question -> (https://interactive-examples.mdn.mozilla.net/pages/js/map.html)",
          tests: [
            {
        ...
        {
          title: "Rendre du code en html preformaté",
        ...
        {
          title: "\":\" en vuejs",
          description: "Que represente \":\" dans ce script \":href=\"url\"\" en vuejs ? (voir minimum sur vuejs 2)",
          choices: [
            { id: "for", label: "v-for" },
        ...
        {
          title: "Methode Http",
          description: "Quel sont les mothode http ?",
          choices: [
        ...
        {
          title: "Quel est la methode utilisé pour cette phrase ?",
        ...
        },
        {
          ...
          description:
            "Faire une expresion regex qui permet de sortire les caractère \"A-a\" ou \"B-b\". \n La phrase qui doit etre avoir les caractère extré : \"Laurent Ruquier (malheureusement accompagné de Romy Schneider) se rapproche de quinze députés déterminés à aller jusqu'au bout.\" ",
          tests: [
            {
              params: [["1", "2", "3"], (element: string) => `test-${element}`],
              expected: ["test-1", "test-2", "test-3"],
