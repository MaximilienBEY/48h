        ...
        <Quiz
            ...
            questions={[
                ...
                },
                {
                    title: "Cyber 3",
                    description:
                        "Le protocole utilisé pour sécuriser les échanges d'e-mails est :",
                    choices: [
                        {id: "stmp", label: "STMP"},
                ...
                },
                {
                    ...
                    choices: [
                        {
                            id: "identifie",
                            label: "Une personne qui identifie les failles des systèmes de sécurité pour percer dans dans des systèmes informatiques a des fins malveillante.",
                            isCorrect: true
                        },
                        {
                            id: "exploite",
                            label: "Une personne qui exploite de manière non éthique les informations sensibles et utilise les failles des systèmes à son avantage."
                        },
                        {
                            id: "agit",
                            label: "Une personne qui agit de manière ethique qui realise des test d'intrusion pour améliorer la sécurité d'un système."
                        }
                    ],
                },
                {
